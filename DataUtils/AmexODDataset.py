...
class AmexODDataset:
    ...
    {
        "prefix": "<OD>",
        "suffix": "label<loc_0><loc_28><loc_136><loc_92>...",
        "image":  "filename.png"
    }

    - Coordinates in suffix are already in 0-1000 scale — passed through as-is.
    - Prefix already contains the <OD> task token — used directly.
    ...
    def _load_and_preprocess(self):
        ...
        try:
            ...
            print(f"[AmexODDataset] ERROR reading {self.json_path}: {e}")
            raw_data = []
        ...
        print(
            f"[AmexODDataset] JSON path : {self.json_path}\n"
            f"[AmexODDataset] Image dir : {self.image_dir}\n"
            f"[AmexODDataset] Total records  : {total:,}\n"
            f"[AmexODDataset] Skipped (empty) : {skipped:,}\n"
